...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1643: x0 => new Uint8Array(x0),
      _1651: x0 => new Int32Array(x0),
      _1655: x0 => new Float32Array(x0),
      _1657: x0 => new Float64Array(x0),
      _1689: (decoder, codeUnits) => decoder.decode(codeUnits),
      _1690: () => new TextDecoder("utf-8", {fatal: true}),
      _1691: () => new TextDecoder("utf-8", {fatal: false}),
      ...
      _1722: s => JSON.stringify(s),
      _1723: s => printToConsole(s),
      _1724: a => a.join(''),
      _1727: (s, t) => s.split(t),
      ...
      _1740: (a, i) => a.push(i),
      _1744: a => a.pop(),
      _1745: (a, i) => a.splice(i, 1),
      _1747: (a, s) => a.join(s),
      _1748: (a, s, e) => a.slice(s, e),
      _1751: a => a.length,
      _1753: (a, i) => a[i],
      _1754: (a, i, v) => a[i] = v,
      _1756: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1757: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1758: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1759: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1760: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1761: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1762: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1763: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1765: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1766: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1767: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1768: (t, s) => t.set(s),
      ...
      _1891: l => arrayFromDartList(Uint8Array, l),
      ...
      _3871: () => globalThis.window,
      _3936: x0 => x0.navigator,
